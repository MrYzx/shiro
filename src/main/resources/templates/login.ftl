...
<head>
    ...
    <style>
        ...
        .forma{color:rebeccapurple;}
        .forma:hover{color:whitesmoke;}
    </style>
</head>
            ...
            <div class="form-horizontal col-md-offset-3" id="login_form">
                ...
                <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control required" type="text" placeholder="请输入验证码" id="verifyCode" name="verifyCode" maxlength="8"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group col-md-offset-9" style="margin-bottom: 20px;">
                        <a class="forma" onclick="toRegister()" style="text-decoration: none;" href="javascript:void(0);">注册 &nbsp;</a>|
                        <a class="forma" style="text-decoration: none;"> &nbsp;忘记密码</a>
                        <button type="button" class="btn btn-success pull-right" name="submit" onclick="login()">登录</button>
                    </div>
                </div>
            </div>
        </div>

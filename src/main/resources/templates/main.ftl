                ...
                <div class="layui-tab-content">
                        ...
                        <form class="layui-form" action="">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <button type="button" class="layui-btn" lay-submit="" lay-filter="demo1">立即提交
                                    </button>
                    ...
                    <div class="layui-tab-item">
                        ...
                        <script type="text/html" id="options">
                            <button type="button" class="layui-btn layui-btn-sm layui-btn-normal" lay-event="viewUser">
                                查看
                            </button>
                            <button type="button" class="layui-btn layui-btn-sm layui-btn-warm" lay-event="removeUser">
                                删除
                            </button>
                        </script>

    ...
    <script>
        ...
        layui.use('table', function() {
            ...
            table.render({
                elem: '#holidayListId',
                id: 'layHolidayListId',
                url: '/com/yzx/holiday2/queryHolidayList?proessName=holiday2',
                title: '请假信息列表',
                toolbar: '#toolbarDemo',
                cellMinWidth: 300,
                page: true, //开启分页
            ...
            function viewHoliday() {
                layer.open({
                    ...
                    content: '/com/yzx/holiday2/queryHoliday?proessName=holiday2',
                });
            };
            ...
            function leave() {
                ...
                $.ajax({
                    type: "post",
                    url: "/com/yzx/holiday2/jugementTask?proessName=holiday2",
                    dataType:"json",
                    cache: false,
                    success:function(d){
                        if(d.flag == true){
                            layer.open({
                                ...
                                shadeClose: false,
                                //遮罩透明度
                                content: '/com/yzx/holiday2/holidayPage',
                            });
                        }else {
            ...
            function compHoliday(taskId,processInstanceId) {
                layer.open({
                    ...
                    area: ['600px', '600px'],
                    shadeClose: false, //点击遮罩关闭
                    content: '/com/yzx/holiday2/messageInfo?taskId='+taskId+"&processInstanceId="+processInstanceId,
                });
            };
